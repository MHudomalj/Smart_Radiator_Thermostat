...
/* configure device name/topic on which the thermostat publishes */
#define DEVICE_NAME "living_room/radiator"

/********************* MQTT MESSAGE CONFIGURATION MACROS **********************/
/* The MQTT topics to be used by the publisher and subscriber. */
#define MQTT_CONFIG_TOPIC					HOME_ASSISTANT_TOPIC"/climate/"DEVICE_NAME"/config"
#define MQTT_ACTION_TOPIC					DEVICE_NAME"/action"
#define MQTT_CURRENT_TEMPERATURE_TOPIC		DEVICE_NAME"/current_temp"
#define MQTT_MODE_COMMAND_TOPIC				DEVICE_NAME"/command"
#define MQTT_MODE_STATE_TOPIC				DEVICE_NAME"/state"
#define MQTT_TARGET_TEMPERATURE_TOPIC		DEVICE_NAME"/target_temp"
#define MQTT_TEMPERATURE_STATE_TOPIC		DEVICE_NAME"/temp_state"
...
#define ENABLE_LWT_MESSAGE                ( 0 )
    ...
    #define MQTT_WILL_TOPIC_NAME          DEVICE_NAME "/will"
    #define MQTT_WILL_MESSAGE             ("MQTT client unexpectedly disconnected!")
#endif

/* MQTT messages which are published on the topics.*/
// Climate configuration message.
#define MQTT_CONFIG_MESSAGE \
"{\n" \
	"\"action_topic\": \""MQTT_ACTION_TOPIC"\",\n" \
	"\"current_temperature_topic\": \""MQTT_CURRENT_TEMPERATURE_TOPIC"\",\n" \
	"\"initial\": 21.0,\n" \
	"\"icon\": \"mdi:radiator\",\n" \
	"\"max_temp\": 30.0,\n" \
	"\"min_temp\": 17.0,\n" \
	...
	"\"precision\": 0.1,\n" \
	"\"retain\": true,\n" \
	"\"temperature_command_topic\": \""MQTT_TARGET_TEMPERATURE_TOPIC"\",\n" \
	"\"temperature_state_topic\": \""MQTT_TEMPERATURE_STATE_TOPIC"\",\n" \
	"\"temperature_unit\": \"C\",\n" \
	"\"temp_step\": 0.5,\n" \
	"\"unique_id\": \"LRradiator1\"\n" \
"}"

// Operation modes messages.
#define MQTT_MODE_OFF_MESSAGE "off"
#define MQTT_MODE_HEAT_MESSAGE "heat"

// Actions messages.
#define MQTT_ACTION_OFF_MESSAGE "off"
#define MQTT_ACTION_HEATING_MESSAGE "heating"
